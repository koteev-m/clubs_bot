...
class DefaultAvailabilityService(
    ...
    override suspend fun listOpenNights(
        ...
        return withRetriedTx(name = "availability.listOpenNights", readOnly = true, database = db) {
            EventsTable
                .selectAll()
    ...
    override suspend fun listFreeTables(
        ...
        return withRetriedTx(name = "availability.listFreeTables", readOnly = true, database = db) {
            val eventRow =
                EventsTable
                    .selectAll()
                    .where {
                    ...
                    .firstOrNull()
                    ?: return@withRetriedTx emptyList()
