...
ALTER TABLE club_ops_chat_config
    ADD CONSTRAINT IF NOT EXISTS chk_club_ops_chat_config_guest_lists_thread_id_positive
        CHECK (guest_lists_thread_id IS NULL OR guest_lists_thread_id > 0),
    ADD CONSTRAINT IF NOT EXISTS chk_club_ops_chat_config_alerts_thread_id_positive
